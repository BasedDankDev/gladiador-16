...
const RENAMES: { slug: string; name: string }[] = [
  { slug: "polo-retro-hombre", name: "Polo Retro Saprissa" },
  { slug: "polo-modernista-hombre", name: "Polo Modernista Saprissa" },
  { slug: "visitante-1986-hombre", name: "Polo Retro Coca Cola" },
  { slug: "adidas-local-hombre", name: "Polo Retro Adidas Local" },
];
